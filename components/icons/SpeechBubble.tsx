...
const SpeechBubbleIcon = ({ classes = '', width = 22, height = 21, isActive = true }: TIconTypes) => {
  return (
    <svg className={cn('shrink-0', classes)} width={width} height={height} fill="none" viewBox="0 0 23 22" xmlns="http://www.w3.org/2000/svg">
      <path
        fill={isActive ? '#1890FF' : '#000'}
